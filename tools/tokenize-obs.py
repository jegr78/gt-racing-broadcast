...
def canonicalize_commentary_mic(d):
    """True iff the commentary mic leaf was rewritten to its committed form. Endurance
    only (a collection with a Stint scene): the solo collections ship the mic hot and
    are regenerated by derive-solo-templates.py, never tokenized."""
