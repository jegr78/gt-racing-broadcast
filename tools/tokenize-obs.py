...
# #593: the endurance commentary mic, folded back to its committed macOS form. An
# export from a producer machine carries its real device id (and, mid-stint, the
# mic open); the template ships the token and the mic closed.
